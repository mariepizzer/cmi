...
// get selected demo
let demo = 'demo1';//getDemos(rootPath)[0];

// under demo paths
const demoPath = path.join(rootPath, "assets");
const distPath = path.join(rootPath, "wwwroot/Content");
const assetDistPath = distPath + '\\assets';
const srcPath = path.join(rootPath, "assets", "src");
